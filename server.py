...
logger_name = env.get('BOT_NAME', default='transparencia-informacoes-obras')
fastapi_logger.name = logger_name

desc = '<a href="https://portaltransparencia.fortaleza.ce.gov.br/#/informacoes/obras" target="_blank">FONTE</a>'

tags_metadata = [
    {
        'name': 'transparencia-informacoes-obras',
        'description': 'Consulta Portal Tranparencia Fortaleza - Informações de obras'
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Tranparencia Fortaleza - Informações de obras', 
    description=desc, 
    debug=False, 
    openapi_tags=tags_metadata,
    openapi_url="/api/transparencia-informacoes-obras/consulta/docs/openapi.json",
    docs_url='/api/transparencia-informacoes-obras/consulta/docs'
)
...
#---------------------------- Endpoints -------------------------------
@app.get(
    path="/api/transparencia-informacoes-obras/consulta", 
    tags=['transparencia-informacoes-obras'],
    responses=responses)
